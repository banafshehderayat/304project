		...
		if ($db_conn) {
				...
				if (array_key_exists('findEmployee', $_POST)){
					...
					if ($r == FALSE){
								...
								echo '<script type="text/javascript">'. 'alert("the employee ID you entered is incorrect")</script>';
							} else {
					...
					if (array_key_exists('update', $_POST)){
							...
							if ($r == FALSE){
								...
								echo '<script type="text/javascript">'. 'alert("the employee information you entered is incorrect")</script>';
							} else{
						...
						if (array_key_exists('delete', $_POST)) {
							...
							if (array_key_exists('addEmployee', $_POST)){
								...
								$r = OCIExecute($stid);
								if ($r == FALSE){
									echo '<script type="text/javascript">'. 'alert("the employee information you entered is invalid")</script>';
